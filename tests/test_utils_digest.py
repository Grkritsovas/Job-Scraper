...
class DigestFormattingTests(unittest.TestCase):
    ...
    def test_html_digest_renders_button_and_hides_raw_url_text(self):
        ...
        self.assertIn('name="viewport"', bodies[0])
        self.assertIn("@media screen and (max-width: 640px)", bodies[0])
        self.assertIn("job-card-badge-cell", bodies[0])
        self.assertIn("max-width:900px", bodies[0])
