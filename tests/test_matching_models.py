...
class MatchingModelsTests(unittest.TestCase):
    def test_embedding_model_catalog_contains_expected_models(self):
        ...
        self.assertEqual(ALL_MPNET_BASE_V2, AVAILABLE_EMBEDDING_MODELS["all_mpnet_base_v2"])
    ...
    def test_ranking_defaults_to_selected_embedding_model(self):
        self.assertEqual(ALL_MPNET_BASE_V2, SELECTED_EMBEDDING_MODEL)
        self.assertEqual(ALL_MPNET_BASE_V2.model_name, EMBEDDING_MODEL_NAME)
