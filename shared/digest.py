...
def _render_html_chunk(company_groups, recipient_profile, total_jobs):
    ...
    return (
        ...
        "<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" "
        "style=\"max-width:920px;background:#ffffff;border-radius:28px;overflow:hidden;\">"
        "<tr><td style=\"padding:0;\">"
        "<div style=\"padding:24px 20px 20px 20px;background:#0f172a;"
        ...
        "</div>"
        "</td></tr>"
        "<tr><td style=\"padding:20px 18px 24px 18px;background:#f8fafc;\">"
        f"{sections_html}"
